...
#pero a diferencia de las listas, las tuplas son inmutables, es decir, no se pueden modificar despues de ser creadas, por lo que no puedes agregar, eliminar o cambiar elementos en una tupla, a diferencia de las listas, donde si puedes modificar los elementos despues de ser creadas